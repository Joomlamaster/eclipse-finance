								...
								<div class="acc">
									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
									    	...
									    	<li><a href="<?php echo $this->createUrl('/profile/default/rates'); ?>">Closed Positions</a></li>
									...
									<div style="margin-top: -4px;">ID:  <?php echo Yii::app()->user->id; ?></div>
									<div style="text-transform:uppercase; color: #3191c7; font-size: 12px; margin-top:-4px;"><?php echo Yii::app()->user->getAccountName(); ?></div>
								</div>						
							</td>
							<td class="balance">
		...
		<div class="nav-bar">
			...
			<div class="h-inner h-nav">
				...
				<ul class="nav">
					...
					<li <?php if($this->id == 'trade'): ?>class="active"<?php endif; ?>><a href="<?php echo $this->createUrl('/page/show', array('page_id' => 39)); ?>">FAQ</a></li>
...
<a href="http://ibofaudit.com/eclipse-finance" class="xp-link" target="_blank"></a>
		...
		<div class="row2">
			...
			<div class="center">
				...
				<p style="font-size: 12px; color: #999;">Eclipse Finance is an innovative binary options trading platform provider that is owned by ______________________________________ and operated by Herrold Capital LLP, a financial services company registered in United Kingdom and authorized by the <a href="http://www.IOIRC.com" target="_blank">IOIRC</a> under License Number IOI897. Herrold Capital LLP is located 3rd Floor, 49 Farringdon Road, London, EC1M 3JP, United Kingdom</p>
<div style="display: block; width: 932px; height: 130px;">
         ...
         <ul>	
				...
				<a href="http://twitter.com/EclipseFinance" target="_blank">
					...
					<span id="twitter_count">3,441</span>
