...
$(function() {
	$('select[name="WithdrawalRequests[status_id]"]').livequery('change', function() {
		...
		$.get('/admin/user/action/chancgeWithdrawalRequests', {'status_id': statusId, 'request_id': requestId}, function(data) { 
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns'=>array(
		...
		array(
			...
			'type' => 'raw',
			'value'=>'$data->payment_methods[$data->payment_method_id]',
			'filter' => false
		),
		array(
			'class'=>'CButtonColumn',
			...
			'buttons'=>array(
				'more' => array(
					'label'=>'More',
					'url'=>'Yii::app()->urlManager->createUrl("admin/user/info/withdrawal_request", array("request_id"=>$data->request_id))',
