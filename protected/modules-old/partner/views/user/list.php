...
?>
<h3>Your percent - <?php echo (int)Yii::app()->user->partner_percent; ?>%</h3>
...
<table class="table">
	...
	<tbody>
		...
		<tr class="<?php echo $key%2 ? 'odd' : 'even'?>">
			...
			<td><?php //echo $user->currency->currency_symbol; ?> <?php echo $profit = ((int)Yii::app()->user->partner_percent/100 * (float)$user->deposit_first); ?></td>
		</tr>
		<?php $summ+=$profit; ?>
		<?php endforeach; ?>
