...
<div style="width:718px;padding:7px;background:#fff;border:1px solid;">
<img src="http://eclipse-finance.com/images/email-banner.png" />
...
<div id="accountTypes">
   ...
   <p style="font: 11px Arial, Helvetica; color: #555;"><em>* Trading Signals are provided by our partner signal service: Top-Binary-Signals.com. For more information about their packages click <a href="http://top-binary-signals.com/vip-members-club" target="_blank">here</a>.</br/>
** Coaching are provided by expert traders of Top-Binary-Signals.com</br/>
*** Managed account services are subject to availability and are provided by Top-Binary-Signals.com. For more information about their Managed Account service click <a href="http://top-binary-signals.com/managed-accounts" target="_blank">here</a>.</em></p>
<p>To learn more about Binary Options please visit our <a href="http://eclipse-finance.com/page/Trading_Academy" target="_blank">Trading Academy</a>.</p>
 
<p>You can also join our <a href="https://www.facebook.com/EclipseFinance" target="_blank">Facebook</a> page or follow us on <a href="http://twitter.com/EclipseFinance" target="_blank">Twitter</a> in order to receive live financial updates and keep track of our current promotions.</p>
 
<p>We would like to take this opportunity to thank you once more for registering with Eclipse Finance. We are proud of our customer service and commitment to trader satisfaction, we strive to provide you with all the support you need in order to learn about the Binary Options market and start your journey to success.</p>

<p>Sincerely</p>

<p style="font: bold 14px Arial, Helvetica;">Eclipse Finance Support Team</p>
<hr/>
<div style="font: 12px Arial; color: #bbb;">

</div>
<img src="http://eclipse-finance.com/images/phone-image.png" width="15" height="15" align="absmiddle"/>&nbsp;United Kingdom HQ: +44-203-514-0009&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://eclipse-finance.com/images/mouse.png" width="15" height="15" align="absmiddle"/>&nbsp;Support@Eclipse-Finance.com<br/>
<img src="http://eclipse-finance.com/images/phone-image.png" width="15" height="15" align="absmiddle"/>&nbsp;Hong Kong Subsidary: +852-300-85890&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://eclipse-finance.com/images/monitor.png" width="15" height="15" align="absmiddle"/>&nbsp;Eclipse-Finance.com<br/>
<img src="http://eclipse-finance.com/images/phone-image.png" width="15" height="15" align="absmiddle"/>&nbsp;US/Canada Toll Free: +1-800-792-4705&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://eclipse-finance.com/images/marker.png" width="15" height="15" align="absmiddle"/>&nbsp;3rd Floor, 49 Farrington Road, London, EC1M 3JP, United Kingdom
</div>
<hr/>
<br/>
  <div style="width: 718px; height: 34px;background: url(http://eclipse-finance.com/images/eclipse-footer-logo.png) repeat scroll -27px 0 #000; background-color: #000; font: 12px Arial, Helvetica; color: #ddd; text-align: center; padding-top: 210px;">
&copy;&nbsp;2001-2014 Eclipse-Finance &reg;&nbsp;Global
</div>
</div>
