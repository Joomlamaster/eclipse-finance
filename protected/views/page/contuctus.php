<style>
.page-content-title span { background: url(/images/letter_from_ceo.png); left: 7px !important; top: 34px;}
.page-content-title { margin-left: -1px !important; }
</style>
...
<h2>Feedback Form</h2>
   ...
   <div class="contact-details-holder" style="display: block; height: 700px; margin-top: 25px;">
      <div style="float: right; width: 444px; margin-left: 44px; color:#928d7d;" >
         <p><h2>Address</h2></p> <p>3rd Floor, 49 Farringdon Road, London,<br/>EC1M 3JP, United Kingdom</p>
         ...
         *Time in British Summer Time (UTC/GMT+1)</p>
         ...
         <!--<img src="../images/uk-flag.png"/>--> <strong>United Kingdom HQ:</strong> +44-203-514-0009<br/>
         <strong>Hong Kong Subsidary:</strong> +852-300-85890<br/>
         <!--<img src="../images/us-flag.png"/>--> <strong>US/Canada Toll Free:</strong> 1-800-792-4705<br/>
         ...
         <strong>Customer Support</strong><br/>Support@eclipse-finance.com<br/><br/>
         <strong>Finance Department</strong><br/>Finance@eclipse-finance.com<br/><br/>
         <strong>General Inquiries</strong><br/>info@eclipse-finance.com<br/><br/>
         <strong>Verification Department</strong><br/>Verification@eclipse-finance.com<br/><br/>
         <strong>Become a Partner</strong><br/>Affiliate@eclipse-finance.com<br/>
      </div>
