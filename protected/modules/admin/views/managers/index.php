...
<table class="table">
	...
	<tbody>
		...
		<tr class="<?php echo $key%2 ? 'odd' : 'even'?>">
			...
			<td>
				<a href="<?php echo $this->createUrl('managers/edit', array('user_id' => $user->user_id));?>">Edit</a> | 
				<a href="<?php echo $this->createUrl('managers/delete', array('user_id' => $user->user_id));?>" onclick="return _confirm('Confirm action', 'Delete user?', this);">Delete</a>
			</td>
		</tr>
		<?php endforeach; ?>
	</tbody>
