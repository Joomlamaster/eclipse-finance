 ...
 * @var Bootstrap $this
 */
//echo Yii::app()->createAbsoluteUrl($this->getAssetsUrl());
// echo Yii::app()->getBaseUrl(true);   // => http://localhost/yii_projects
//echo $this->getAssetsUrl(); exit;
//echo Yii::app()->getHomeUrl();       // => /yii_projects/index.php
//echo Yii::app()->getBaseUrl(false);  // => /yii_projects
//die();
return array(
	...
	'bootstrap-yii' => array(
		'baseUrl' => Yii::app()->createAbsoluteUrl($this->getAssetsUrl()),
